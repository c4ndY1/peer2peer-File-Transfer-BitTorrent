...
# Do not force a module-level logging level here; use global configuration to control verbosity
...
class PeerTCPServer:
    ...
    async def _accept(self, reader: asyncio.StreamReader, writer: asyncio.StreamWriter):
        ...
        try:
            ...
            logger.info('accepted incoming connection for info_hash=%s from %s', info_hash.hex(), peer)
