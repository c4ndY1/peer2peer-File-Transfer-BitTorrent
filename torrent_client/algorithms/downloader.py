...
class Downloader(QObject):
    ...
    async def _execute_block_requests(self, processed_requests: List[BlockRequestFuture]):
        while True:
            ...
            peer_data = self._peer_manager.peer_data
            # print(f"requests_pending: {requests_pending}")
    ...
    async def run(self):
        ...
        # if self._non_started_pieces:
        #     for piece_index in range(len(self._download_info._pieces)):
        #         piece_info = self._download_info.pieces[piece_index]
        ...
        # self._non_started_pieces = self._get_non_finished_pieces()
        # print("hellojk")
        # print(self._non_started_pieces)
        ...
        # Assuming torrent_info is already defined and contains all necessary information

        # Create an instance of TorrentState
        # torrent_state = TorrentState(self.torrent_info)
        # print("helloww")
        

        # print('progress %.1lf%% (%s / %s pieces)', floor_to(torrent_state.progress * 100, 1),
        #                   self._download_info.downloaded_piece_count, torrent_state.selected_piece_count)
